    ...
    ui.prompt = function (text, defaultInputText, callback, isImage) {
        ...
        var createDialog = function () {
            ...
            if(isImage){
                ...
                spacer.className = "btn btn-success fileinput-button";
                spacer.style.marginLeft = "20px";
                box.appendChild(spacer);

                var icon = $('<i class="icon-plus icon-white"></i><span>select files</span>');
                var input1 = $('<input id="fileupload" type="file" name="files[]" multiple/>');

                $(spacer).append(icon).append(input1);
